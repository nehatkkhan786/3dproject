  ...
  return (
   <Container maxWidth='xl'>
        <Box sx={{display:'flex', justifyContent:'space-between', paddingTop:2, alignItems:'center'}}>
            ...
            <IconButton id="basic-menu"
                onClick={handleClick} sx={{display:{xs:'flex', sm:'flex', md:'none', lg:'none'}}}>
            ...
            >
               ...
               <MenuItem><Button variant='contained' endIcon={<EmojiPeopleIcon/>}>SAY HELLO</Button></MenuItem>
